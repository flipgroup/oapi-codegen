...
type GetTestByNameResponse struct {
	...
	assert.Contains(t, code, "func (c *HttpClient) GetTestByName(ctx context.Context, name string, params GetTestByNameParams, reqEditors ...RequestEditorFn) (*http.Response, error) {")
	assert.Contains(t, code, "func (c *Client) GetTestByName(ctx context.Context, name string, params GetTestByNameParams, reqEditors ...RequestEditorFn) (*GetTestByNameResponse, error) {")
